            ...
            <table border="1">
                ...
                foreach ($etudiant as $et) {
                    ...
                    <tr>
                        ...
                        <td><?php echo"<a href=../Controller/C_supprime.php?codeetud=" . $et['codeetudiant'] . " " . "onclick='return confirmation();'" . ">" ?> Supprimer <img src="../bootstrap-icons-1.8.3/trash.svg" height="14" width="25"/></a> </td>
                    </tr>
                    <?php
                }
                ?>
